...
import { getAllHarvestRequests } from "../../../services/HarvestRequestService";

const HistoryRequestOrder = () => {
    ...
    useEffect(() => {
        const fetchRequests = async () => {
            try {
                ...
                console.log("Dữ liệu từ API:", data); // Log dữ liệu để kiểm tra
                setRequests(data);
            } catch (error) {
...
export default HistoryRequestOrder;
