...
import { ChevronLeft, ChevronRight, Clock, Package, DollarSign, FileText, TrendingUp } from "lucide-react"
...
const ImportProductList = () => {
  ...
  // Cấu hình Slider với custom arrows
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Product List - Improved Container */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          {productList.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-6">Hiện tại không có sản phẩm nào</p>
              <button
                onClick={handleCreateOrder}
...
const ProductItem = ({ product }) => {
  ...
  return (
    <div className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
      ...
      <div className="p-4">
        ...
        <div className="mb-4 p-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200">
          ...
          {timeLeft.total > 0 ? (
            <div className={`text-xs font-bold ${isUrgent ? "text-red-600" : "text-green-600"}`}>
              {timeLeft.days} {t("common.days")} {timeLeft.hours} {t("common.hours")} {timeLeft.minutes}{" "}
              {t("common.minutes")} {timeLeft.seconds} {t("common.seconds")}
            </div>
          ) : (
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-4 py-2 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center"
        >
          <FileText className="w-4 h-4 mr-2" />
